...
add_action( 'after_setup_theme', 'thachpham_custom_background_setup', 15 );
 ...
 * @return void
 */
function thachpham_custom_background_setup() {
	...
	add_theme_support(
		...
		array(
			...
			'default-image'    => '',
			'wp-head-callback' => 'thachpham_custom_background_callback',
		)
	);
}
 ...
 * @return void
 */
function thachpham_custom_background_callback() {
